...
内部人员用 Excel / CSV 填写，一行一条训练样本：

```
| 原始识别文本       | 动词   | 量词 | 主体 | 项目词 | 分类 | 金额 | 收支 | 正确文本           |
|-------------------|--------|------|------|--------|------|------|------|-------------------|
| 记一笔流连50元      | 记一笔 | 元   | 个人 | 榴莲   | 餐饮 | 50   | 支出 | 记一笔榴莲50元      |
| 公司买水角30块      | 买     | 块   | 公司 | 水饺   | 餐饮 | 30   | 支出 | 公司买水饺30块      |
| 交通会15元         | -      | 元   | 个人 | 交通费 | 交通 | 15   | 支出 | 交通费15元         |
| 充话费100块        | 充     | 块   | 个人 | 话费   | 通讯 | 100  | 支出 | 充话费100元        |
| 发了工资5000元     | 发了   | 元   | 个人 | 工资   | 收入 | 5000 | 收入 | 发了工资5000元      |
| 公司报销打车费30元  | 报销   | 元   | 公司 | 打车   | 交通 | 30   | 收入 | 公司报销打车费30元   |
| 买了两斤水果蓝85块  | 买了   | 块   | 个人 | 水果篮 | 购物 | 85   | 支出 | 买了两斤水果篮85块   |
```
...
逐行对比「原始识别文本」和「正确文本」，用 diff 算法提取错词对：
...
写入 `asr_corrections` 表，识别时先做文本替换。
